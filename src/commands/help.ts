...
const helpCategories = {
  ...
  skilling: {
    ...
    commands: [
      ...
      '`/gather [material] [quantity]` - Gather cloth materials for magic robes',
      '`/craft <item> [quantity]` - Craft arrows, leather armor, and magic robes',
  ...
  information: {
    ...
    commands: [
      ...
      '`/list gathering` - Gathering & magic robes guide',
