...
const itemSchema = new mongoose.Schema({
  ...
  subType: { 
    type: String, 
    enum: ['melee', 'ranged', 'magic', 'ammunition', 'helmet', 'chest', 'legs', 'boots', 'gloves', 'shield', 'ring', 'necklace', 'pickaxe', 'rod', 'axe', 'raw', 'cooked', 'ore', 'bar', 'wood', 'component', 'fish', 'leather', 'misc'],
    required: true 
  },
